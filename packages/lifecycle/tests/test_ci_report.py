...
def _cases():
    return [
        ...
        {"title": "checkout", "status": "FAIL", "evidence_url": "",
...
def test_comment_contains_marker_summary_and_table() -> None:
    md = render_pr_comment(
        cases=_cases(), passed=1, failed=1, duration_ms=42_000,
...
def test_comment_all_green() -> None:
    md = render_pr_comment(
        ...
        passed=1, failed=0, duration_ms=1000, dashboard_url="",
    )
...
def test_comment_without_dashboard_still_renders() -> None:
    ...
    md = render_pr_comment(cases=_cases(), passed=1, failed=1,
                           duration_ms=None, dashboard_url="")
