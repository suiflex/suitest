...
function printHelp() {
  process.stdout.write(
    [
      ...
      "",
      "Targets:      claude-code, claude-desktop, cursor, windsurf, codex,",
      "              gemini-cli, vscode, copilot-cli, opencode, antigravity,",
      "              antigravity-cli, hermes, openclaw, cline, roo, generic-json",
      "",
      "Init flags:    --ide claude-code|cursor|windsurf, --base-url,",
      "               --api-url, --api-key, --yes",
